...
void Run(int argn, char** argv)
{
    ...
    arg.res = "results/res_" + temp_name +"_algo=" + arg.algo + "_S=" + to_string(arg.Rumor_num) + "_K=" + to_string(arg.k) + "_T=" + to_string(arg.T) 
    + "_epsilon=" + to_string(arg.epsilon) + "_gamma=" + to_string(arg.gamma) + "_A=" + to_string(arg.A);
